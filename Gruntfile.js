...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    //this task will compile all less files upon saving to create both Patron.css and Patron.min.css
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/Patron.css": "build/less/Patron.less",
      ...
      production: {
        ...
        files: {
          // compilation.css  :  source.less
          "dist/css/Patron.min.css": "build/less/Patron.less",         
          //Skins minified
